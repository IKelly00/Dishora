...
@section('content')
    ...
    <div class="container mb-4">
        ...
        <div class="main-content-area">
            ...
            {{-- Main Form --}}
            <form method="POST" action="{{ route('customer.start.selling.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('fullname') is-invalid @enderror"
                                    ...
                                    value="{{ old('fullname', $fullname ?? '') }}" required>
                            </div>
                            @error('fullname')
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                    ...
                                    placeholder="e.g., 09123456789" value="{{ old('phone_number') }}" required>
                            </div>
                            @error('phone_number')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="e.g. Restaurant, Grocery, etc." value="{{ old('business_type') }}"
                                        required>
                                </div>
                                @error('business_type')
                                    <div class="error-message">{{ $message }}</div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea class="form-control @error('business_description') is-invalid @enderror" id="business_description"
                                        name="business_description" placeholder="Enter your business description" rows="3" required>{{ old('business_description') }}</textarea>
                                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <input type="text" class="form-control @error('street') is-invalid @enderror"
                                    name="street" id="street_name" value="{{ old('street') }}" required>
                                @error('street')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                                    ...
                                    @foreach (['Mon' => 'Monday', 'Tue' => 'Tuesday', 'Wed' => 'Wednesday', 'Thu' => 'Thursday', 'Fri' => 'Friday', 'Sat' => 'Saturday', 'Sun' => 'Sunday'] as $short => $day)
                                        <tr>
                                            ...
                                            <td><input type="time"
                                                    ...
                                                    name="open_time[{{ $day }}]"
                                                    value="{{ old("open_time.$day") }}"></td>
                                            <td><input type="time"
                                                    class="form-control form-control-sm @error("close_time.$day") is-invalid @enderror"
                                                    name="close_time[{{ $day }}]"
                                                    value="{{ old("close_time.$day") }}"></td>
                                            <td>
                                                <select class="form-select form-select-sm"
                                                    name="status[{{ $day }}]">
                                                    <option value="open"
                                                        {{ old("status.$day", 'open') === 'open' ? 'selected' : '' }}>Open
                                                    </option>
                                                    <option value="closed"
                                                        {{ old("status.$day") === 'closed' ? 'selected' : '' }}>Closed
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                            ...
                            <div class="border rounded p-3 h-100">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        ...
                                        value="{{ old('business_permit') ? basename(old('business_permit')) : 'None' }}"
                                        readonly>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-sm btn-secondary cancel-btn me-1"
                            ...
                            <div class="border rounded p-3 h-100">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        ...
                                        value="{{ old('mayors_permit') ? basename(old('mayors_permit')) : 'None' }}"
                                        readonly>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-sm btn-secondary cancel-btn me-1"
